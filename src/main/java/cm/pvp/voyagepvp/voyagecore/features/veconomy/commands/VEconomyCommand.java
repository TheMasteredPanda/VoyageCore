...
import cm.pvp.voyagepvp.voyagecore.features.veconomy.commands.player.LedgerCommand;
...
public class VEconomyCommand extends VoyageCommand
{
    public VEconomyCommand(VEconomy feature)
    {
        ...
        addChildren(new BalanceCommand(feature), new TransferCommand(feature), new BankCommand(feature), new LedgerCommand(feature));
    }
